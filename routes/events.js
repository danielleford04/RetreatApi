                  ...
                  follow_up_id = post._id;
                    ...
                    if(default_id != null) {
                        ...
                        Phase.find({ event_id: default_id } , function (err, post) {
                            ...
                            createDefaultTasksInstructionsEmails(registration_id,default_registration_id);
                            createDefaultTasksInstructionsEmails(preparation_id,default_preparation_id);
    ...
    function createDefaultTasksInstructionsEmails(phase_id, default_phase_id) {
        ...
        Instruction.find({ phase_id: default_phase_id } , function (err, post) {
            ...
            for (let instruction of post) {
                ...
                if (instruction.content) {instruction_body.content = instruction.content}
